...
export const ButtonsCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "h-fit w-full bg-white rounded-xl border border-neutral-100  dark:border-white/[0.2] hover:border-neutral-200 group/btn overflow-hidden relative flex items-center justify-center",
        className
      )}
    >
